...
/**
 * @brief set the i2c sda and scl pin
 * 
 * @param sda_pin sda pin no. Default pin 21
 * @param scl_pin scl pin no. Default pin 22
 */
void esp32_i2c_set_pin(int sda_pin, int scl_pin);

/**
 * @brief initialize the i2c as master.
 * 
 * call esp32_i2c_set_pin() function calling this function.
 */
void esp32_i2c_master_init(void);

/**
 * @brief initialize the i2c as slave.
 * 
 * call esp32_i2c_set_pin() function calling this function.
 ...
 * @brief 
 * 
 * @param sensor_address pointer where retrive sensor address stored.
 * @return true if return ESP_OK else @return false 
 */
