...
const char *TAG_MPU6050 = "mpu6050.c";
...
void mpu6050_init()
{
    if(esp32_i2c_get_sensor_address(&mpu6050_device_address) == false)
    {
...
/* ------------------------------------------------------ */
void mpu6050_madgwick_quaternion_update( float accel_x, float accel_y, float accel_z, 
